      ...
      <div class="food-content">
        ...
        <div class="content">
          ...
          <div class="cartcontrol-wrapper">
            <cartcontrol :food="food" v-on:cart-add="addCart"></cartcontrol>
          </div>
          <transition>
        ...
        <div class="ratings">
          ...
          <ratingselect @selectRating="selectRating" @toggleRating="toggleRating" :selectType="selectType" :onlyContent="onlyContent" 
...
export default {
  ...
  methods: {
    ...
    selectRating(myselectType){
      this.selectType = myselectType;
      this.$nextTick(() =>{
        this.scroll.refresh();
      })
    },
    toggleRating(myonlyContent){
      this.onlyContent =myonlyContent;
      this.$nextTick(() =>{
        this.scroll.refresh();
      })
    }
