<template>
  <div class="goods">
    ...
    <div class="foods-wrapper" ref="foodsWrapper">
      <ul>
        <li v-for="(item,index) in goods" class="food-list food-list-hook" :key="index">
          ...
          <ul>
            <li class="food-item border-1px" v-for=" (food,index) in item.foods " @click="selectFood(food,$event)" :key="index">
              <div class="icon">
    ...
    <food :food="selectedFood" ref="food" v-on:food-add="foodHandlecartAdd"></food>
  </div>
</template>
